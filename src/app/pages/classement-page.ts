...
export class ClassementPage implements OnInit {
  ...
  private defaults: Entry[] = [
    ...
    { id: 'd20', title: 'Dragon Ball Z',                    year: 1989, score: 8.5, category: 'Anime',  emoji: '💥', poster: `${T}/iq7bUwIXFDr6EFfAMBs95gJGFnL.jpg` },
    { id: 'd21', title: 'Naruto',                           year: 2002, score: 8,   category: 'Anime',  emoji: '🍃', poster: `${T}/xppeysfvDKVx775MFuH8Z9Ex9BN.jpg` },
    { id: 'd22', title: 'My Hero Academia',                 year: 2016, score: 8,   category: 'Anime',  emoji: '🦸', poster: `${T}/iv8o9KAjAXkxUFQ5oaHZVEMhFGT.jpg` },
    { id: 'd23', title: 'One Piece',                        year: 1999, score: 7.5, category: 'Anime',  emoji: '🏴‍☠️', poster: `${T}/fcXdAofcwbIFkgQJExvvhxLedVr.jpg` },
    // Séries
    ...
    { id: 'd29', title: 'Prison Break',                     year: 2005, score: 8,   category: 'Séries', emoji: '🔓', poster: `${T}/2NOHBGhCCQH7s7gy5FXHIYM1C9X.jpg` },
